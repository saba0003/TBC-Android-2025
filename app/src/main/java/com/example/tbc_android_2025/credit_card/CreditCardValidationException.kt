...
import com.example.tbc_android_2025.commons.StringUtils.ERR_CARD_NUMBER
...
class UnsupportedCardNumberException(number: String) :
    CreditCardValidationException(message = ERR_CARD_NUMBER.format(number))