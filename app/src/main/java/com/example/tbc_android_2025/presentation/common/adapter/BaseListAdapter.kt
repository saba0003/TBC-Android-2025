...
import com.example.tbc_android_2025.presentation.common.fragment.ViewBindingInflater
...
abstract class BaseListAdapter<T : HasId<*>, VB : ViewBinding>(
    ...
    private val delegate by lazy { BaseAdapterDelegate(inflater = inflater, onClick = onClick) }
